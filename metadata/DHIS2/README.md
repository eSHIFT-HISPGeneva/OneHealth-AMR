The metadata file(s), when loaded into DHIS2 using standard metadata import mechanisms, instantiate a national-level end-point for cross-sector AMR surveillance. The core artifacts created include:
